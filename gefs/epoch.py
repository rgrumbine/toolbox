...
class climate:
    ...
    def __init__(self):
      self.x = []
      self.x.append( epoch('climate/epoch1994_icetk.nc') )
      self.x.append( epoch('climate/epoch1994_icec.nc') )
      self.x.append( epoch('climate/epoch1994_sst.nc') )
      self.x.append( epoch('climate/epoch1994_uswrf.nc') )

      self.x.append( epoch('climate/epoch1994_prmsl.nc') )
      self.x.append( epoch('climate/epoch1994_z1mb.nc') )
      self.x.append( epoch('climate/epoch1994_z10mb.nc') )
...
class climate2:
    ...
    def __init__(self):
      ...
      self.x.append( epoch('climate/epoch1994_u10m.nc') )
      self.x.append( epoch('climate/epoch1994_v10m.nc') )
