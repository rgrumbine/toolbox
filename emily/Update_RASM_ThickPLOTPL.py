...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 15:41:08 2019
...
print ("RASM-ESRL Thickness PLOTS PL!")
...
str_timeD5 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
...
tvalue = num2date(nctime,units=t_unit)
str_timeD1 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
...
titlenew05 = str("ESRLNew Ice by day"+ str(str_timeD5) )  
...
plt.colorbar(dog,orientation='vertical', shrink=0.5)
 ...
 ######## Save first plot  
titlesub05 = str("Ice Thick Diff ESRL"+ str(str_timeD5) + " - " + str(str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plotTH_diff5_ESRL2.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
plt.colorbar(cat,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
  ...
  ######## Save first plot  
title5 = str("Ice Thick ESRL"+ str(str_timeD5))  
plt.title(title5, fontsize=ftitle)
plt.savefig('plotTH_Day5_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
title11 = str("Ice Thick ESRL"+ str(str_timeD1))  
plt.title(title11, fontsize=ftitle)
plt.savefig('plotTH_Day1_ESRL.png', bbox_inches="tight")
plt.clf()
plt.cla()
plt.close()
...
data10 = ncRASM10.variables['hi'][0,:]
...
#t_cal = ncRASM5.variables[tname].calendar
tvalue = num2date(nctime,units=t_unit)
str_timeD10 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
ncRASM10.close()
...
x, y = m(*np.meshgrid(lon,lat))
cs =m.pcolormesh(x,y,Mask10,shading='flat', cmap=plt.cm.get_cmap('RdBu', 5))
...
plt.colorbar(dog,orientation='vertical', shrink=0.5)
      ######## Save first plot  
titlesub10 = str("Ice Thick Diff ESRL"+ str(str_timeD10) + " - " + str(str_timeD1))  
plt.title(titlesub10, fontsize=ftitle)

plt.savefig('plotTH_diff10_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
plt.colorbar(cat,orientation='vertical', shrink=0.5)
  ...
  ######## Save first plot
title10 = str("Ice Thick ESRL"+ str(str_timeD10))  
plt.title(title10, fontsize=ftitle) # Set the name of the variable to plot

plt.savefig('plotTH_Day10_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
#t_cal = ncRASM5.variables[tname].calendar
tvalue = num2date(nctime,units=t_unit)
str_timeD2 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
ncRASM2.close()
...
title1 = str("Ice Thick ESRL"+ str(str_timeD2))  
plt.title(title1, fontsize=ftitle)
plt.savefig('plotTH_Day2_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
plt.colorbar(dog,orientation='vertical', shrink=0.5)
 ...
 ######## Save first plot  
titlesub05 = str("Ice Thick Diff ESRL"+ str(str_timeD2) + " - " + str(str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plotTH_diff2_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
tvalue = num2date(nctime,units=t_unit)
str_timeD3 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
...
title1 = str("Ice Thick ESRL"+ str(str_timeD3))  
plt.title(title1, fontsize=ftitle)
plt.savefig('plotTH_Day3_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
plt.colorbar(dog,orientation='vertical', shrink=0.5)
 ...
 ######## Save first plot  
titlesub05 = str("Ice Thick Diff ESRL"+ str(str_timeD3) + " - " + str(str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plotTH_diff3_ESRL.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
tvalue = num2date(nctime,units=t_unit)
str_timeD4 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
...
pony =m.pcolormesh(x,y,data1,shading='flat', cmap=cmap)
...
######## Save first plot  
title1 = str("Ice Thick ESRL"+ str(str_timeD4))  
plt.title(title1, fontsize=ftitle)
plt.savefig('plotTH_Day4_ESRL.png', bbox_inches="tight")
plt.clf()
plt.cla()
plt.close()
