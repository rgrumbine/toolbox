...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 15:56:15 2019
...
ncGIO5 = Dataset("GIO5.nc", "r", format="NETCDF4")
...
GIO_str_timeD5 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO5.variables['latitude'][:,:]
lons =ncGIO5.variables['longitude'][:,:]

datag5 = ncGIO5.variables['iiceconc'][:,:]
datag5 = datag5[0][:][:]
ncGIO5.close()

ncGIO1 = Dataset("GIO001.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_timeD1 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

datag1 = ncGIO1.variables['iiceconc'][:,:]
datag1 = datag1[0][:][:]
ncGIO1.close()
...
nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = nps(lons, lats)
...
pps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = pps(lons, lats)
...
titlesub05 = str("GIOPS Ice Conc Diff"+ str(GIO_str_timeD5) + " - " + str(GIO_str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plot_diff5_GIOPS.png', bbox_inches="tight")
plt.clf()
plt.cla()
plt.close()
...
nns = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = nns(lons, lats)
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
title5 = str("GIOPS Ice Conc"+ str(GIO_str_timeD5 ))  
plt.title(title5, fontsize=ftitle)
      
plt.savefig('plot_Day_GIOPS5.png', bbox_inches="tight")
plt.clf()
plt.cla()
plt.close()
...
title5 = str("GIOPS Ice Conc"+ str(GIO_str_timeD1))  
plt.title(title5, fontsize=ftitle)
          
plt.savefig('plot_Day_GIOPS1.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
ncGIO10 = Dataset("GIO1010.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_timeD10 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats =ncGIO10.variables['latitude'][:,:]
lons =ncGIO10.variables['longitude'][:,:]

datag10 = ncGIO10.variables['iiceconc'][:,:]
datag10 = datag10[0][:][:]
...
plt.title(titlesub05, fontsize=ftitle)
    ...
    ##fig, ax = plt.figure()
plt.savefig('plot_diff10_GIOPS.png', bbox_inches="tight")
#plt.show()
   # plt.gcf().clear()
plt.clf()
plt.cla()
...
title10 = str("GIOPS Ice Conc"+ str(GIO_str_timeD10))  
plt.title(title10, fontsize=ftitle)
        
plt.savefig('plot_Day10_GIOPS.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
ncRIO_IT = Dataset("RIO_INIT.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
RIO_str_timeIT = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncRIO_IT.variables['latitude'][:,:]
lons =ncRIO_IT.variables['longitude'][:,:]

dataRIT = ncRIO_IT.variables['iiceconc'][:,:]
dataRIT = dataRIT[0][:][:]
...
rnps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = rnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.1, 1.1);
plt.colorbar(csRI,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titleRIOIT = str("RIOPS Ice Conc"+ str(RIO_str_timeIT) )  
plt.title(titleRIOIT, fontsize=ftitle)
    
plt.savefig('Plot_RIO0_IT.png', bbox_inches="tight")
#plt.show(csRI)
plt.clf()
plt.cla()
plt.close()
...
ncRIO_12 = Dataset("RIO12.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
RIO_str_time12 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncRIO_12.variables['latitude'][:,:]
lons =ncRIO_12.variables['longitude'][:,:]

dataRIT = ncRIO_12.variables['iiceconc'][:,:]
dataRIT = dataRIT[0][:][:]
...
r12nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = rnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.1, 1.1);
plt.colorbar(csRI12,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titleRIOIT = str("RIOPS 12hr"+ str(RIO_str_time12) )  
plt.title(titleRIOIT, fontsize=ftitle)
    
plt.savefig('plot_hour12_RIOPS1.png', bbox_inches="tight")
#plt.show(csRI12)
plt.clf()
plt.cla()
plt.close()
...
ncRIO_24 = Dataset("RIO24.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
RIO_str_time24 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncRIO_24.variables['latitude'][:,:]
lons =ncRIO_24.variables['longitude'][:,:]

dataRIT24 = ncRIO_24.variables['iiceconc'][:,:]
...
########### RIO########################################
plt.figure(figsize=(14,10))
r24nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = rnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.1, 1.1);
plt.colorbar(csRI24,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titleRIOIT = str("RIOPS 24 hr"+ str(RIO_str_time24) )  
plt.title(titleRIOIT, fontsize=ftitle)
    
plt.savefig('plot_hour24_RIOPS2.png', bbox_inches="tight")
#plt.show(csRI24)
plt.clf()
plt.cla()
plt.close()
...
ncRIO_36 = Dataset("RIO36.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
RIO_str_time36 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncRIO_36.variables['latitude'][:,:]
lons =ncRIO_36.variables['longitude'][:,:]

dataRIT36 = ncRIO_36.variables['iiceconc'][:,:]
...
r36nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = rnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.0, 1.1);
plt.colorbar(csRI36,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titleRIOIT = str("RIOPS 36 hr"+ str(RIO_str_time36) )  
plt.title(titleRIOIT, fontsize=ftitle)
    
plt.savefig('plot_hour36_RIOPS3.png', bbox_inches="tight")
#plt.show(csRI36)
plt.clf()
plt.cla()
plt.close()
...
ncRIO_48 = Dataset("RIO48.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
RIO_str_time48 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncRIO_48.variables['latitude'][:,:]
lons =ncRIO_48.variables['longitude'][:,:]

dataRIT48 = ncRIO_48.variables['iiceconc'][:,:]
...
r4nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat,resolution='h')
x , y = rnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.0, 1.1);
plt.colorbar(csRI4,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titleRIOIT = str("RIOPS 48 hr"+ str(RIO_str_time48) )  
plt.title(titleRIOIT, fontsize=ftitle)
    
plt.savefig('plot_hour48_RIOPS4.png', bbox_inches="tight")
#plt.show(csRI4)
plt.clf()
plt.cla()
plt.close()
...
#######################################
ncGIO_IN = Dataset("GIO_IN.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_timeIT = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO_IN.variables['latitude'][:,:]
lons =ncGIO_IN.variables['longitude'][:,:]

dataGIT = ncGIO_IN.variables['iiceconc'][:,:]
dataGIT = dataGIT[0][:][:]
...
gnps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = gnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.0, 1.1);
#plt.colorbar(csGI ,orientation='vertical', shrink=0.5)
plt.colorbar(csGI,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)



titlenew10 = str("GIOPS Ice Conc"+ str(GIO_str_timeIT) )  
plt.title(titlenew10, fontsize=ftitle)
    
plt.savefig('Plot_GIO_IT.png', bbox_inches="tight")
#plt.show(csGI)
plt.clf()
plt.cla()
plt.close()
...
ncGIO_2 = Dataset("GIO002.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_time2 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO_2.variables['latitude'][:,:]
lons =ncGIO_2.variables['longitude'][:,:]

datag2 = ncGIO_2.variables['iiceconc'][:,:]
datag2 = datag2[0][:][:]
...
g2nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = gnps(lons, lats)
   # cs =nps.pcolormesh(x,y,icediff,shading='flat',cmap=plt.cm.seismic) PiYG RdBu  spectral' 'AntiqueWhite'
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.0, 1.1);
#plt.colorbar(csG2 ,orientation='vertical', shrink=0.5)
plt.colorbar(csG2,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
 
  
titlenew10 = str("GIOPS Ice Conc"+ str(GIO_str_time2) )  
plt.title(titlenew10, fontsize=ftitle)
    
plt.savefig('plot_Day_GIOPS2.png', bbox_inches="tight")
#plt.show(csG2)
plt.clf()
plt.cla()
plt.close()
...
titlesub05 = str("GIOPS Ice Conc Diff"+ str(GIO_str_time2) + " - " + str(GIO_str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plot_diff2_GIOPS.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
ncGIO_3 = Dataset("GIO003.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_time3 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO_3.variables['latitude'][:,:]
lons =ncGIO_3.variables['longitude'][:,:]
datag3 = ncGIO_3.variables['iiceconc'][:,:]
datag3 = datag3[0][:][:]
...
g3nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat, resolution='h')
x , y = g3nps(lons, lats)
...
plt.clim(0.0, 1.1);
#plt.colorbar(csG3 ,orientation='vertical', shrink=0.5)
plt.colorbar(csG3,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   

titlenew10 = str("GIOPS Ice Conc"+ str(GIO_str_time3) )  
plt.title(titlenew10, fontsize=ftitle)
    
plt.savefig('plot_Day_GIOPS3.png', bbox_inches="tight")
#plt.show(csG3)
plt.clf()
plt.cla()
plt.close()
...
titlesub05 = str("GIOPS Ice Conc Diff"+ str(GIO_str_time3) + " - " + str(GIO_str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plot_diff3_GIOPS.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
ncGIO_4 = Dataset("GIO004.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_time4 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO_4.variables['latitude'][:,:]
lons =ncGIO_4.variables['longitude'][:,:]
dataGIT = ncGIO_4.variables['iiceconc'][:,:]
dataGIT = dataGIT[0][:][:]
...
g4nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat,resolution='h')
x , y = g4nps(lons, lats)
cmap= mpl.colors.ListedColormap(['cornflowerblue', 'aquamarine', 'yellow', 'orange', 'red'])
...
plt.clim(0.0, 1.1);
plt.colorbar(csG4,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
titlenew10 = str("GIOPS Ice Conc"+ str(GIO_str_time4) )  
plt.title(titlenew10, fontsize=ftitle)
    
plt.savefig('plot_Day_GIOPS4.png', bbox_inches="tight")
#plt.show(csG4)
plt.clf()
plt.cla()
plt.close()
...
ncGIO_7 = Dataset("GIO7.nc", "r", format="NETCDF4")
...
tvalue = num2date(nctime,units=t_unit)
GIO_str_time7 = [i.strftime("%Y-%m-%d %H") for i in tvalue]

lats = ncGIO_7.variables['latitude'][:,:]
lons =ncGIO_7.variables['longitude'][:,:]
dataGIT = ncGIO_7.variables['iiceconc'][:,:]
dataGIT = dataGIT[0][:][:]
...
g7nps = polar_stere(minGLon, maxGLon, minGLat,maxGLat,resolution='h')
x , y = g7nps(lons, lats)
...
plt.clim(0.0, 1.1);
plt.colorbar(csG7,orientation='vertical', shrink=0.5, ticks=bounds, spacing='proportional',  cmap=cmap)
   
titlenew10 = str("GIOPS Ice Conc"+ str(GIO_str_time7) )  
plt.title(titlenew10, fontsize=ftitle)
    
plt.savefig('plot_Day_GIOPS7.png', bbox_inches="tight")
#plt.show(csG7)
plt.clf()
plt.cla()
plt.close()
