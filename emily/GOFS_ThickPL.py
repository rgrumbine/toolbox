...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 15:38:29 2019
...
############3 PLOTS WONT WORK ON CRON WITHOUT
...
str_timeD7 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
ncgo_7.close()
...
tvalue = num2date(nctime,units=t_unit)
str_timeD0 = [i.strftime("%Y-%m-%d %H:%M") for i in tvalue]
ncgo0.close()

#data2 = ncRASM1.variables['hi'][:,:]
#data2 = data2[0][:][:]
...
plt.colorbar(dog,orientation='vertical', shrink=0.5)
 ...
 ######## Save first plot  
titlesub05 = str("GOFS Ice Thick Diff "+ str(str_timeD5) + " - " + str(str_timeD1))  
plt.title(titlesub05, fontsize=ftitle)
         
plt.savefig('plotTH_diff5_GOFS.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
# ticks=bounds,
plt.colorbar(cat,orientation='vertical', shrink=0.5,  spacing='proportional',  cmap=cmap)
   
  
  ######## Save first plot  
title5 = str("Ice Thick GOFS"+ str(str_timeD5))  
plt.title(title5, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay5.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
plt.colorbar(cats,orientation='vertical', shrink=0.5,  spacing='proportional',  cmap=cmap)
   
  
  ######## Save first plot  
title5 = str("Ice Thick GOFS"+ str(str_timeD7))  
plt.title(title5, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay7.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
# ticks=bounds,
  ...
  ######## Save first plot  
title5 = str("Ice Thick GOFS"+ str(str_timeD0))  
plt.title(title5, fontsize=ftitle)
plt.savefig('TH_GOFS_INIT.png', bbox_inches="tight")
#plt.show()
plt.clf()
plt.cla()
plt.close()
...
title11 = str("Ice Thick GOFS"+ str(str_timeD1))  
plt.title(title11, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay1.png', bbox_inches="tight")
#plt.show()
   # plt.gcf().clear()
plt.clf()
plt.cla()
...
title11 = str("Ice Thick GOFS"+ str(str_timeD2))  
plt.title(title11, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay2.png', bbox_inches="tight")
#plt.show()
   # plt.gcf().clear()
plt.clf()
plt.cla()
...
title11 = str("Ice Thick GOFS"+ str(str_timeD3))  
plt.title(title11, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay3.png', bbox_inches="tight")
#plt.show()
   # plt.gcf().clear()
plt.clf()
plt.cla()
...
title11 = str("Ice Thick GOFS"+ str(str_timeD4))  
plt.title(title11, fontsize=ftitle)
plt.savefig('TH_GOFS_goDay4.png', bbox_inches="tight")
#plt.show()
   # plt.gcf().clear()
plt.clf()
plt.cla()
