...
for nlim in range(2,3):
  ...
  print(cluster.covariances_[0], file = fmodel)
  print(cluster.covariances_[1], file = fmodel) # n_components of them, 18x18 matrix each
  ...
  for i in range(0, count):
    ...
    #print("c {:d}".format(ypr_pred[i]) , file=fout)
