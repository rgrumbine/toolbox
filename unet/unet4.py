...
def build_unet(input_shape=(64, 64, 1)):
    ...
    concat3 = layers.concatenate([u3, d4]) # Skip connection from Encoder Block 3
...
unet_model = build_unet(input_shape=(ny, nx, 1))
...
# Input Grid (t-1)
im0 = ax[0].imshow(X_val[sample_idx].squeeze(), cmap='Blues_r', origin='upper', vmin=0, vmax=1)
