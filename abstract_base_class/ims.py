...
while (tag <= end_date):
  print(tag)  
  x3.get_grid(tag, '/home/Robert.Grumbine/clim_data/verification_data/ims/')
  x3.make_edge(tag, '/home/Robert.Grumbine/clim_data/verification_data/ims/',
