...
initial_date = datetime.date(2018,9,1)
tag      = initial_date
end_date = datetime.date(2019,12,31)
dt = datetime.timedelta(1)

#print("getting an ncepgrid", flush=True)
#x3.get_grid(tag, '/home/Robert.Grumbine/clim_data/verification_data/ice5min/')
#print("back with ncepgrid")
#
#x3.make_edge(tag, '/home/Robert.Grumbine/clim_data/verification_data/ice5min/',
#   '/home/Robert.Grumbine/clim_data/verification_data/edges/',
#   '/home/Robert.Grumbine/rgdev/ice_scoring/NCEP_si_verf/exec/',
#   '/home/Robert.Grumbine/rgdev/ice_scoring/NCEP_si_verf/fix/' )
